// Mobile · Lista de Lançamentos (com filtros, swipe-to-delete, recorrências)

function TransactionsList({ theme }) {
  const days = [
    { day: 'Hoje · 15 mai', total: -86.4, items: [
      ...
      { cat: 'mercado',     desc: 'Mercado Bom Preço', val: -25.9, when: '17:30', card: 'Itaú',
        swipe: true },
    ]},
    { day: 'Ontem · 14 mai', total: 1480.9, items: [
      { cat: 'mercado',     desc: 'Hortifruti São João', val: -82.9, when: '19:00', card: 'Itaú' },
      { cat: 'compras',     desc: 'Renner · parcela 3/6', val: -149.9, when: '12:14',
        card: 'Itaú', recur: true },
        ...
        <div style={{ marginTop: 14, display: 'flex', gap: 6, overflowX: 'auto',
          ...
          {[
            ...
            <div key={i} style={{
              ...
              border: f.active ? 'none' : `0.5px solid ${theme.hair}`,
          ...
          <div key={di} style={{ marginTop: 16 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between',
              ...
              <span style={{ fontFamily: PQ_T.mono, fontSize: 11,
                color: d.total >= 0 ? theme.positive : theme.mute,
                fontWeight: 500 }}>
...
Object.assign(window, { TransactionsList });
